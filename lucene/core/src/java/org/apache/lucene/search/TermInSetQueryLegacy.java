 ...
 * Query q1 = new TermInSetQueryLegacy("field", new BytesRef("foo"), new BytesRef("bar"));
 *
 ...
 */
public class TermInSetQueryLegacy extends MultiTermQuery implements Accountable {

  private static final long BASE_RAM_BYTES_USED =
      RamUsageEstimator.shallowSizeOfInstance(TermInSetQueryLegacy.class);

  private final String field;
  private final PrefixCodedTerms termData;
  private final int termDataHashCode; // cached hashcode of termData

  public TermInSetQueryLegacy(String field, Collection<BytesRef> terms) {
    this(field, packTerms(field, terms));
  }

  public TermInSetQueryLegacy(String field, BytesRef... terms) {
    this(field, packTerms(field, Arrays.asList(terms)));
  }

  /** Creates a new {@link TermInSetQueryLegacy} from the given collection of terms. */
  public TermInSetQueryLegacy(
  ...
  /** Creates a new {@link TermInSetQueryLegacy} from the given array of terms. */
  public TermInSetQueryLegacy(RewriteMethod rewriteMethod, String field, BytesRef... terms) {
    this(rewriteMethod, field, Arrays.asList(terms));
  }

  private TermInSetQueryLegacy(String field, PrefixCodedTerms termData) {
  ...
  private boolean equalsTo(TermInSetQueryLegacy other) {
